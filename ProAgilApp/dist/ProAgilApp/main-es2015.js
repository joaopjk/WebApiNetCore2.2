...
function EventosComponent_tbody_27_tr_1_img_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstyleProp"]("width", ctx_r4.imagemLargura, "px")("margin", ctx_r4.imagemMargen, "px");
...
function EventosComponent_tbody_27_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, EventosComponent_tbody_27_tr_1_Template, 19, 9, "tr", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class EventosComponent {
    ...
    getEventos() {
        this.http.get('http://localhost:5000/api/values').subscribe(response => { this.eventos = response; }, error => {
            console.log(error);
        });
    }
}
...
EventosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventosComponent, selectors: [["app-Eventos"]], decls: 29, vars: 4, consts: [[1, "form-inline"], [1, "form-group", "mb-2"], [1, "mr-2"], ["type", "text", "placeholder", "Buscar", 1, "form-control", "mr-2", 3, "ngModel", "ngModelChange"], [1, "table", "table-striped"], [1, "thead-dark"], [1, "btn", "btn-outline-primary", 3, "click"], [4, "ngIf"], [4, "ngFor", "ngForOf"], [3, "src", "width", "margin", 4, "ngIf"], [1, "btn", "btn-success"], [1, "btn", "btn-danger"], [3, "src"], ["colspan", "7", 1, "text-center"]], template: function EventosComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventosComponent_Template_button_click_11_listener($event) { return ctx.alternarImagem(); });
...
class AppComponent {
    constructor() {
        this.title = 'ProAgilApp';
    }
}
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(); };
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 9, vars: 1, consts: [[1, "container"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](7, "app-Eventos");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
module.exports = __webpack_require__(/*! C:\Users\pj_pj\OneDrive\Área de Trabalho\Projetos\WebApiNetCore2.2\ProAgilApp\src\main.ts */"./src/main.ts");
